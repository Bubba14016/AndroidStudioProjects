...
public class InicioEmpresaActivity extends AppCompatActivity
    ...
    public void sucursal(View view){
        Intent intent= new Intent(this, NuevaSucursalActivity.class);
        startActivity(intent);
    }

    public void producto(View view){
        Intent intent= new Intent(this, NuevoProdActivity.class);
        startActivity(intent);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.inicio_empresa, menu);
        return true;
    }
